...
- **Human-in-the-loop** — is an AI approach that combines human intelligence with machine learning models during training, testing, or operation. Instead of letting an AI make decisions completely on its own (fully automated), a human stays in Human-in-the-Loop and corrects the AI when a mistake is made 
